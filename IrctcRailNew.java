...
import org.openqa.selenium.support.ui.Select;
	...
	public class IrctcRailNew {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			IrctcRailNew kk = new IrctcRailNew();
			...
			kk.driver_new("userRegistrationForm:dobDay","16" );
			kk.driver_new("userRegistrationForm:dobMonth", "JUN");
		...
		public void  driver_new (String x, String y){
			
			ChromeDriver driverx = new ChromeDriver();
			
		
			
			Select Dropd = new Select(driverx.findElementById("x"));
			Dropd.selectByVisibleText("y");
